...
daniel = Partner("Chai", "Daniel", "dc8291")
etai = Partner("Liokumovich", "Etai", "etailkmv")
team = [daniel, etai]

problem1 = Problem("Avoiding World War", 'wicked', "AvoidWar")
 # In this case, the Python file for the formulation would be named End_Poverty.py.

problems = [problem1]

our_submission = Who_and_what([daniel, etai], OPTION_A, problems)
